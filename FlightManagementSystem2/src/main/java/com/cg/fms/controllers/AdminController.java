...
//	@GetMapping("/sheduledFlights/{src}/{dsc}/{date}")
//	public List<ScheduledFlight> ViewScheduledFlightBySdd(@PathVariable String src, @PathVariable String dsc,@PathVariable String date){
//		String url = "http://localhost:8085/sheduledFlights";
//		List<ScheduledFlight> list = Arrays.asList(rt.getForObject(url, ScheduledFlight[].class));
//		return list;
//		}
//	@GetMapping("/scheduledFlights/{fno}")
//	public List<ScheduledFlight> ViewScheduledFlights(@PathVariable("fno") long fno){
//		String url = "http://localhost:8085/sheduledFlights";
//		RestTemplate rt = new RestTemplate();
//		List<ScheduledFlight> list = Arrays.asList(rt.getForObject(url, ScheduledFlight[].class));
//		return list;
...
//	public List<ScheduledFlight> updateScheduledFlight(@RequestBody ScheduledFlight scheduledFlight){
//		String url = "http://localhost:8085/sheduledFlights";
//		RestTemplate rt = new RestTemplate();
//		List<ScheduledFlight> list = Arrays.asList(rt.getForObject(url, ScheduledFlight[].class));
//		return list;
...
//	public String deleteScheduledFlight(@PathVariable("id") long id){
//		String url = "http://localhost:8080/scheduledFlights/"+id;
//		rt.delete(url);
//		return "Deleted";
//	}
...
//@GetMapping("/admins")
//public List<Admin> fetchAllAdmins() throws NoBookingDetailsFoundByIdException{
//	return as.findAll();
//	}
//@Operation(summary="To add AdminAunthenticate Details...")
